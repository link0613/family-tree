  ...
  var TreeBuilder = (function () {
    ...
    _createClass(TreeBuilder, [{
      ...
      value: function create() {
        ...
        // Compute the layout.
        this.tree = d3.layout.tree().nodeSize([nodeSize[0] * 2, nodeSize[1] * 1.5]);
        ...
        _.forEach(this.siblings, function (d) {
          ...
          var end = allNodes.filter(function (v) {
            ...
            if (end[0]) {
                ...
                d.target.x = Math.abs(d.source.x);
      ...
      key: '_nodeRendererNew',
      value: function _nodeRendererNew(name, x, y, height, width, extra, id, nodeClass, textClass, textRenderer) {
      ...
      value: function _textRenderer(name, extra, textClass) {
        ...
        node += extra.shortName +'\n';
        node += '<br />' +
                  '<span style="font-size: 9px;">'
                    + (extra.birth != null ? extra.birth : '')
                    + (extra.death != null ? ' - ' + extra.death : '')
                + '</span>';
        node += '</p>\n';
        return node;
      }
      ...
      var opts = _.defaultsDeep(options || {}, {
        ...
        callbacks: {
          ...
          nodeRenderer: function nodeRenderer(name, x, y, height, width, extra, id, nodeClass, textClass, textRenderer) {
            return TreeBuilder._nodeRendererNew(name, x, y, height, width, extra, id, nodeClass, textClass, textRenderer);
          },
    ...
    _preprocess: function _preprocess(data, opts) {
      ...
      var reconstructTree = function reconstructTree(person, parent) {
        if(person.marriages !== undefined){
            person.extra.marriages = person.marriages;
        }
        ...
        _.forEach(person.marriages, function (marriage, index) {
          ...
          var spouse = {
            ...
            if (spouse.extra.extraTree && spouse.extra.extraTree == true) {
