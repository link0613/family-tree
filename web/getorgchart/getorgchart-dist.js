...
getOrgChart = function (b, a) {
    ...
    this._aF = {};
    this._a8 = {found: [], showIndex: 0, oldValue: "", timer: ""};
    this._8();
...
getOrgChart.prototype._8 = function () {
    this._width = get._r().msie ? this.element.clientWidth : window.getComputedStyle(this.element, null).width;
    this._width = parseInt(this._width);
    if (this._width < 3) {
        this._width = 1024;
        this.element.style.width = "1024px"
    }
    this._height = get._r().msie ? this.element.clientHeight : window.getComputedStyle(this.element, null).height;
    ...
    var a = getOrgChart.INNER_HTML.replace("[theme]", this.config.theme).replace("[color]", this.config.color).replace(/\[height]/g, this._areaHeight).replace(/\[toolbar-height]/g, this.theme.toolbarHeight);
    if (getOrgChartW) {
        a = a.slice(0, -6);
        a += getOrgChartW
    }
...
getOrgChart.prototype.changeColorScheme = function (a) {
    ...
    this._p._styledContainer.className = this._p._styledContainer.className.replace(this.config.color, a);
    this.config.color = a
};
...
getOrgChart.prototype._k = function () {
    ...
    for (var a in this.nodes) {
        ...
        this._nodeOnClick("renderNodeEvent", {node: c, content: d});
        e.push(d.join(""));
...
getOrgChart.prototype.draw = function (a) {
    console.log('> getOrgChart.prototype.draw()');
    this._p._aN();
    this._aB();
    this._p._graphArea.innerHTML = this._k();
    this._p._aH();
...
getOrgChart.prototype._w = function (a) {
    ...
    for (var c = 0; c < g.length; c++) {
        ...
        h[4] = e.x;
        h[5] = e.y;
        get._w(f, {transform: b}, {transform: h}, 200, get._w._aX, function (i) {
...
getOrgChart.prototype._am = function (c, b) {
    console.log('> getOrgChart.prototype._am()');
...
getOrgChart.prototype._ai = function (b, a) {
    console.log('> getOrgChart.prototype._ai()');
...
getOrgChart.prototype.move = function (direction, offset, b) {
    console.log('> getOrgChart.prototype.move(): coordsArray => ', direction);
    console.log('> getOrgChart.prototype.move(): a => ', offset);
    console.log('> getOrgChart.prototype.move(): b => ', b);

    var h = getOrgChart.util._getViewBoxCoords(this._p);
    ...
    if (g) {
        get._w(this._p._svgElement, {viewBox: h}, {viewBox: e}, 300, get._w._az, function () {
            if (b) {
                b()
            }
        })
    } else {
        this._p._svgElement.setAttribute("viewBox", e)
    }

    return this
};
getOrgChart.prototype.isCollapsed = function (a) {
    if ((a.parent == this._rootNode) || (a.parent == null)) {
        return false
    }
...
getOrgChart.prototype._d = function () {
    console.log('> getOrgChart.prototype._d()');
    if (this.config.enableGridView) {
...
getOrgChart.prototype._aP = function (a, b) {
    console.log('> getOrgChart.prototype._aP()');
...
getOrgChart.prototype._addEventHandler = function (eventName, eventHandler) {
    console.log('> getOrgChart.prototype._addEventHandler() => b', eventName);
    console.log('> getOrgChart.prototype._addEventHandler() => a', eventHandler);
...
getOrgChart.prototype._initEvents = function () {
    console.log('> getOrgChart.prototype._initEvents()');
...
getOrgChart.prototype._nodeOnClick = function (eventName, node) {
    console.log('> getOrgChart.prototype._nodeOnClick() b => ', eventName);
    console.log('> getOrgChart.prototype._nodeOnClick() a => ', node);
...
getOrgChart._p.prototype._aN = function () {
    console.log('> getOrgChart.prototype._aN()');
    this._styledContainer = this.element.getElementsByTagName("div")[0];
    var a = this._styledContainer.children;
    this._searchArea = a[0];
    this._graphArea = a[1];
    this._graphAreaInvisible1 = a[2];
    this._graphAreaInvisible2 = a[3]
};
getOrgChart._p.prototype._aH = function () {
    console.log('> getOrgChart.prototype._aH()');
    ...
    this._av = this._styledContainer.getElementsByClassName("get-left")[0];
    this._i = this._styledContainer.getElementsByClassName("get-down")[0];
    this._zh = this._styledContainer.getElementsByClassName("get-up")[0]
};
...
getOrgChart._p.prototype.getNodeById = function (a) {
    return this._svgGRootElement.querySelector("[data-node-id='" + a + "']")
};
...
getOrgChart.util._getViewBoxCoords = function (_p) {
    console.log('> getOrgChart.util._getViewBoxCoords()');
    console.log('> _p', _p);
...
getOrgChart.util._I = function (element) {
    console.log('> getOrgChart.util._I()');
...
getOrgChart.util._K = function (f) {
    console.log('> getOrgChart.util._K()');
    var h = [], c;
...
getOrgChart.prototype._au = function (g, d) {
    ...
    if (this.config.enableMove) {
        ...
        function h() {
            ...
            get._w(i._p._av, {left: -30, opacity: 0}, {left: 1, opacity: 0.8}, 500, get._w._7);
            get._w(i._p._zh, {top: 19, opacity: 0}, {top: 49, opacity: 0.8}, 500, get._w._7);
            get._w(i._p._i, {bottom: -30, opacity: 0}, {bottom: 1, opacity: 0.8}, 500, get._w._7)
        }
        ...
        function f() {
            ...
            get._w(i._p._av, {left: 1, opacity: 0.8}, {left: -30, opacity: 0}, 500, get._w._7, function () {
                i._ak = null
            });
            get._w(i._p._zh, {top: 49, opacity: 0.8}, {top: 19, opacity: 0}, 500, get._w._7, function () {
                i._ak = null
            });
            get._w(i._p._i, {bottom: 1, opacity: 0.8}, {bottom: -30, opacity: 0}, 500, get._w._7, function () {
                i._ak = null
            })
        }
...
getOrgChart.prototype._a0 = function (c, b) {
    ...
    clearTimeout(this._a8.timer);
    this._a8.timer = setTimeout(function () {
        a._a8.found = a._Z(a._p._searchInput.value);
...
getOrgChart.prototype.highlightNode = function (nodeId) {
    ...
    function b() {
        var d = self.nodes[nodeId];
        var e = getOrgChart.util._getViewBoxCoords(self._p);
        var f = d.x - self.initialViewBoxMatrix[2] / 2 + d.w / 2;
        var g = d.y - self.initialViewBoxMatrix[3] / 2 + d.h / 2;
        self.move([f, g, self.initialViewBoxMatrix[2], self.initialViewBoxMatrix[3]], null, function () {
...
getOrgChart.prototype._t = function (c, e, b, a) {
    ...
    if (!this._nodeOnClick("createNodeEvent", {node: d})) {
        return null
    }
    if (this.nodes[c]) {
